...
public class Main {
    ...
    private static void printMortgage(int principal, float annuelInterest, byte years){
    ...
    private static void printPaymentSchedule(int principal, float annuelInterest, byte years){
        System.out.println();
        System.out.println("PAYMENT SCHEDULE");
        System.out.println("----------------");
        for (short month=1; month<=years * MONTHS_IN_YEAR; month++){
            double balance = calculateBalance(principal, annuelInterest,years,month);
